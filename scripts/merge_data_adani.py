...
with open(base / "adani_daily_sentiment.json", "r", encoding="utf-8") as f:
    sentiment = json.load(f)
with open(base / "adani_prices.json", "r", encoding="utf-8") as f:
    prices = json.load(f)
...
output_path = base / "adani_merged.json"
